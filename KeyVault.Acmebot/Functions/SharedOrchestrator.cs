...
{
    [Microsoft.Azure.Functions.Worker.Function(nameof(IssueCertificate))]
    public async Task IssueCertificate([Microsoft.Azure.Functions.Worker.OrchestrationTrigger] IDurableOrchestrationContext context)
    {
